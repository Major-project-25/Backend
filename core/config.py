...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+psycopg2://kyc:knowyourcampus@192.168.66.210:5432/knowyourcampus" #WIFI
    #DATABASE_URL: str = "postgresql+psycopg2://kyc:knowyourcampus@10.100.211.92:5432/knowyourcampus" #HOTSPOT
